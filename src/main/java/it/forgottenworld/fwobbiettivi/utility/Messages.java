...
public class Messages {
    ...
    public static final String NO_CONSOLE = ConfigUtil.getConfigStringLang("no_console");
    public static final String NO_PERM = ConfigUtil.getConfigStringLang("no_perm");
    public static final String CONFIG_RELOAD = ConfigUtil.getConfigStringLang("config_reload");
    public static final String NO_TOWN_LOC = ConfigUtil.getConfigStringLang("no_town_loc");
